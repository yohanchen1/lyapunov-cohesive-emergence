...
// Module: DGNG.Theorem3_n
// Imports: public import Init public import Mathlib.Tactic public import DGNG.GraphTheory
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_DGNG_DGNG_Theorem3__n(uint8_t builtin) {
lean_object * res;
